Redmine シングルインスタンス<br>テンプレート概要説明
====
...
インスタンスを作成し、Redmine及び周辺パッケージをインストールします。
...
|---|---|---|---|
|Redmine|3.2|[GNU General Public License v2 (GPL)](http://www.gnu.org/licenses/old-licenses/gpl-2.0.html)|プロジェクト管理アプリ|
